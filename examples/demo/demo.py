...
def setup_builder() -> muwanx.Builder:
    ...
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/agilex_piper/scene.xml"),
        name="Agilex Piper",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/agility_cassie/scene.xml"),
        name="Agility Cassie",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/aloha/scene.xml"),
        name="ALOHA",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/anybotics_anymal_b/scene.xml"),
        name="ANYmal B",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/anybotics_anymal_c/scene.xml"),
        name="ANYmal C",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/apptronik_apollo/scene.xml"),
        name="Apptronik Apollo",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/arx_l5/scene.xml"),
        name="ARX L5",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/berkeley_humanoid/scene.xml"),
    ...
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/booster_t1/scene.xml"),
        name="Booster T1",
    )
    menagerie_project.add_scene(
        model=load_model(
    ...
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/dynamixel_2r/scene.xml"),
        name="Dynamixel 2R",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/flybody/scene.xml"),
        name="Flybody",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/fourier_n1/scene.xml"),
        name="Fourier N1",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/franka_emika_panda/scene.xml"),
        name="Franka Emika Panda",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/franka_fr3/scene.xml"),
        name="Franka FR3",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/google_barkour_v0/scene.xml"),
        name="Google Barkour v0",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/google_barkour_vb/scene.xml"),
        name="Google Barkour vB",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/google_robot/scene.xml"),
        name="Google Robot",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/hello_robot_stretch/scene.xml"),
    ...
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/i2rt_yam/scene.xml"),
        name="i2RT YAM",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/iit_softfoot/scene.xml"),
        name="IIT SoftFoot",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/kinova_gen3/scene.xml"),
        name="Kinova Gen3",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/kuka_iiwa_14/scene.xml"),
        name="KUKA iiwa 14",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/leap_hand/scene_left.xml"),
        name="LEAP Hand Left",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/leap_hand/scene_right.xml"),
        name="LEAP Hand Right",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/low_cost_robot_arm/scene.xml"),
        name="Low Cost Robot Arm",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/pal_talos/scene_motor.xml"),
        name="PAL Talos (Motor Control)",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/pal_talos/scene_position.xml"),
        name="PAL Talos (Position Control)",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/pal_tiago/scene_motor.xml"),
        name="PAL TIAGo (Motor Control)",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/pal_tiago/scene_position.xml"),
        name="PAL TIAGo (Position Control)",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/pal_tiago/scene_velocity.xml"),
    ...
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/pndbotics_adam_lite/scene.xml"),
    ...
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/robot_soccer_kit/scene.xml"),
        name="Robot Soccer Kit",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/robotiq_2f85/scene.xml"),
        name="Robotiq 2F85",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/robotiq_2f85_v4/scene.xml"),
    ...
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/shadow_hand/scene_right.xml"),
        name="Shadow Hand Right",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/skydio_x2/scene.xml"),
        name="Skydio X2",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/stanford_tidybot/scene.xml"),
    ...
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/trossen_vx300s/scene.xml"),
        name="Trossen VX300S",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/trossen_wx250s/scene.xml"),
        name="Trossen WX250S",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/trs_so_arm100/scene.xml"),
        name="TRS SO-ARM100",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/ufactory_lite6/scene.xml"),
        name="UFactory Lite6",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/ufactory_xarm7/scene.xml"),
        name="UFactory xArm7",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/umi_gripper/scene.xml"),
        name="UMI Gripper",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/unitree_a1/scene.xml"),
        name="Unitree A1",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/unitree_g1/scene.xml"),
        name="Unitree G1",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/unitree_go1/scene.xml"),
        name="Unitree Go1",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/unitree_go2/scene.xml"),
        name="Unitree Go2",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/unitree_h1/scene.xml"),
        name="Unitree H1",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/unitree_z1/scene.xml"),
        name="Unitree Z1",
    )
    menagerie_project.add_scene(
        model=load_model(
    ...
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/wonik_allegro/scene_left.xml"),
        name="Wonik Allegro Left",
    )
    menagerie_project.add_scene(
        model=load_model("assets/scene/mujoco_menagerie/wonik_allegro/scene_right.xml"),
