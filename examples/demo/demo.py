...
def main():
    ...
    # =======================
    demo_project = builder.add_project(name="Muwanx Demo")
    ...
    # ============================
    menagerie_project = builder.add_project(name="MuJoCo Menagerie")
    ...
    # =============================
    playground_project = builder.add_project(name="MuJoCo Playground")
    ...
    # 4. MyoSuite Project
    # ====================
    myosuite_project = builder.add_project(name="MyoSuite")
